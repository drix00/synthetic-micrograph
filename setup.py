...
# Project modules.
from micrograph import __author__, __email__, __version__,  __project_name__
...
setup(
    ...
    description="Synthetic SEM micrograph for algorithm testing for resolution measurement",
    long_description=long_description,
    keywords="micrograph sem python simulation modeling science physics",
    url="https://github.com/drix00/synthetic-micrograph",
    project_urls={
